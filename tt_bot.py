...
repl_txt1 = (
    ...
    f'5. Для того чтобы записаться или отменить запись: вступите в чат тенниса по ссылке ниже и напишите боту {bot_name_val}, далее используйте кнопки:\n\n'
    f'<b>{but4_text}</b>\n <b>{but6_text}</b>.\n\n'
...
repl_txt18 = 'Привет!\n\n Я бот 🏓🎾 теннис🎾🏓 Мякинино парк. Чем могу помочь? 😊\n\n Воспользуйтесь кнопочками внизу ↘️'
